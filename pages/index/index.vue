		...
		<view class="idxMain">
			...
			<view class="shopOver">
				<view class="contTitle">
					<view class="idxMainBox">行业动态</view>
				</view>
				<view class="idxMainBox">
			...
			<view class="contBg">
				<view class="contTitle">
					<view class="idxMainBox">实时在线数据曲线图</view>
				</view>
				<view class="newsOver">
					<view class="idxMainBox">
						<view class="newsTitle">历史数据浏览1小时更新一次</view>
						<view class="newsImg"><image src="../../static/banner.jpg" mode="aspectFit"></image></view>
						<view class="newsTime"><text>浏览：50</text><text>2019-07-30</text></view>
					</view>
				</view>
			</view>
			<!--内容3-->
	...
	export default {
		data() {
			return {
				...
				contOneList:[
					{ id:1, title:'使用手册', author:'博成', updateTime:'2019-7-30', imgs:'../../static/banner.jpg' },
					{ id:2, title:'系统公告', author:'博成', updateTime:'2019-7-30', imgs:'../../static/banner.jpg' },
				],//内容1
				
				contTwoList:[
					{ id:1, imgs:'../../static/banner.jpg', name:'产品中心', money:'0', yu:'0' },
					{ id:2, imgs:'../../static/banner.jpg', name:'解决方案', money:'0', yu:'0' },
				],//内容2
